...
namespace CodeDemo14112023.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var productManagementContext = _context.Products.Include(p => p.Category).Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Name,Description,Avatar,UserId,DateUpdate,Price,Quantity,Status")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryId,Name,Description,Avatar,UserId,DateUpdate,Price,Quantity,Status")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
